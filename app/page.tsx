...
import { ArrowRight, Users, Calendar, Award, MessageSquare, Shield, Zap, CheckCircle, Globe2, Lock } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex justify-center mb-6">
              <img src="/branding/logo.png" alt="EventLink" className="h-12 w-auto" />
            </div>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              🎟️ Connect with India's Biggest Events.
              <span className="text-accent block mt-2">Volunteer, gain experience, and earn verified certificates</span>
            </h1>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Volunteer, gain experience, and earn verified certificates — all in one platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 text-gray-700">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-3">
              <img src="/branding/logo.png" alt="EventLink" className="h-8 w-auto" />
              <span className="text-xl font-semibold">EventLink</span>
            </div>
            <p>Connect volunteers with organisers across India. Earn verified certificates for your contributions.</p>
          </div>
          <div>
